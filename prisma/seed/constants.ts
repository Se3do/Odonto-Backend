...
export const diagnoses = [
  ...
  {
    id: ids.diagnoses.chronicApicalPeriodontitis,
    name: 'Chronic Apical Periodontitis',
  },
  {
    id: ids.diagnoses.acutePeriapicalAbscess,
...
export const users = [
  {
    ...
    passwordHash:
      '$2b$12$W/d6QJamB8Zpm5UWFTnbruqR6MW05ftnIUPnx6bau/fqbVPC.dxme',
    Role: Role.Admin,
    xpTotal: 1200,
    currentStreak: 7,
    longestStreak: 12,
...
export const caseDefinitions = [
  {
    ...
    patientHistory:
      'The patient reports spontaneous pain, worse at night, with lingering cold sensitivity.',
    difficulty: 'MEDIUM',
    diagnosisExplanation:
      'Symptoms and thermal response are most consistent with irreversible pulpitis.',
  ...
  },
  {
    ...
    patientHistory:
      'Facial swelling developed over two days with a fluctuant vestibular abscess.',
    difficulty: 'HARD',
    diagnosisExplanation:
      'The localized swelling and purulence suggest an acute periapical abscess.',
  ...
  },
  {
    ...
    patientHistory:
      'The patient is concerned about root exposure and sensitivity during brushing.',
    difficulty: 'EASY',
    diagnosisExplanation:
      'The pattern of recession and sensitivity is consistent with gingival recession.',
...
export const dailyCaseDates = [
  {
    id: ids.dailyCases.one,
    date: new Date('2026-01-10T00:00:00.000Z'),
    caseId: ids.cases.caseOne,
  },
  {
    id: ids.dailyCases.two,
    date: new Date('2026-01-11T00:00:00.000Z'),
    caseId: ids.cases.caseTwo,
  },
  {
    id: ids.dailyCases.three,
    date: new Date('2026-01-12T00:00:00.000Z'),
    caseId: ids.cases.caseThree,
  },
] as const;
